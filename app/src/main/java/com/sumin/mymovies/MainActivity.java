...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<JSONObject> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //loadmanager нужен для управления загрузками
        ...
        //если доходит до конца страницы - загрузить еще
    ...
    // 1 метод самые популярные за последнее время, 2 метод самые рейтинговые
    ...
    private void downloadData(int methodOfSort, int page) {
        ...
        //при рестарте идет проверка на текущую загрузку, если загрузка не идет, то loadermanager создает ее из бандла
    ...
    public Loader<JSONObject> onCreateLoader(int i, @Nullable Bundle bundle) {
        ...
        //при загрузке меняет статус загрущки
